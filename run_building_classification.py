...
import time
import requests
import building_classification.building_classification as building_classification
import sys
import logging
import json
...
def import_config():
    ...
    for line in f.readlines():
        settings[line.split(',')[0]] = settings[line.split(',')[1].split('#')[0]]
...
print('')
print('Max size = ' + str(sys.maxsize) + ", Version: " + str(sys.version))
...
if response.status_code == 200:
    ...
    for textLine in jsonText[327:]:
        ...
        result = building_classification(usr_settings, LAD_Code, Year)
        LAD_count += 1
